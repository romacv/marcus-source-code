# 03. Подключение коннектора (OAuth flow)
...
**Next read →** [04-mcp-connector-guide.md](./04-mcp-connector-guide.md) — руководство по submission в Anthropic и ChatGPT директории.
