...
Полный архив проекта Markus. Экспортирован из чата 26 апреля 2026, реструктурирован 6 мая 2026.
...
| [00-vision.md](./00-vision.md) | Что такое Markus, аудитория, privacy posture, MVP юзкейс, pitch |
...
| [06-naming-and-trademark.md](./06-naming-and-trademark.md) | Название Markus, домены, "Second Brain" safety |
