...
- Allowed patterns only, in this order: the service's own connector with the user's OAuth; a per-request header used in memory for one call. Details: `docs/third-party-credentials.md`.
